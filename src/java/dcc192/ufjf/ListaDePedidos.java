...
public class ListaDePedidos {
    ...
    public static List<Pedido> getInstance(){
        if(pedidos == null){
            ...
            pedidos.add(new Pedido("0001", "21/04/2018", (float) 40.00, ListaDeMesas.getInstance().get(0), "Ronaldo S.", "00:00"));                  
            pedidos.add(new Pedido("0002", "21/04/2018", (float) 90.00, ListaDeMesas.getInstance().get(1), "Raquel F.", "00:00"));                  
            pedidos.add(new Pedido("0003", "21/04/2018", (float) 58.00, ListaDeMesas.getInstance().get(2), "Vania B.", "00:00"));                  
