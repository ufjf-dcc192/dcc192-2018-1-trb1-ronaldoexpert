...
public class ListaDePedidos {
    ...
    public static List<Pedido> getInstance(){
        if(pedidos == null){
            ...
            pedidos.add(new Pedido("0001", "21/04/2018", (float) 80.00, ListaDeMesas.getInstance().get(0), "Ronaldo S."));                  
            pedidos.add(new Pedido("0003", "21/04/2018", (float) 40.00, ListaDeMesas.getInstance().get(1), "Raquel F."));                  
            pedidos.add(new Pedido("0003", "21/04/2018", (float) 50.00, ListaDeMesas.getInstance().get(2), "Vania B."));                  
